...
const Navbar = () => {
  return (
    <div className="flex justify-between w-full px-10 h-28 items-center z-10">
      <SpinningText />
      <a href="mailto:subhashnayak131@gmail.com">
        <div className="border p-4 rounded-full flex w-fit items-center justify-center gap-2  mr-20 scale-90 hover:scale-100 transition-all cursor-pointer">
